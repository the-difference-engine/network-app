...
ActiveRecord::Schema.define(version: 20160807032051) do
  ...
  create_table "follow_up_lists_students", id: false, force: :cascade do |t|
    t.integer "follow_up_list_id", null: false
