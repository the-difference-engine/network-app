class StudentsController < ApplicationController  
  ...
  def show
    ...
    @default_message = "Greetings #{@student.full_name}!\n\n#{@employer.rep_full_name} from #{@employer.name } viewed your profile on ACLTC Network App and would like to connect!\n\nView their Employer profile http://network-app-production.com/employers/#{@employer.id} or reply to this email to start a conversation." if current_employer
