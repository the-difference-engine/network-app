class StudentsController < ApplicationController  
  ...
  def show
    ...
    if !@student.hide_profile || current_admin || current_student && current_student.id == @student.id
      ...
      @default_message = "Greetings #{@student.full_name}!\n\n#{@employer.rep_full_name} from #{@employer.name } viewed your profile on DevHero and would like to connect!\n\nView their employer profile http://network-app-staging.herokuapp.com/employers/#{@employer.id} or reply to this email to start a conversation." if current_employer
